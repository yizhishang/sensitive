package com.github.yizhishang.sensitive.test.core.sensitive.entry;
...
import com.github.yizhishang.sensitive.test.model.sensitive.entry.UserCollection;
import com.github.yizhishang.sensitive.test.model.sensitive.entry.UserEntryBaseType;
import com.github.yizhishang.sensitive.test.model.sensitive.entry.UserEntryObject;
...
public class SensitiveEntryTest {
    ...
    public void sensitiveEntryObjectTest() {
        ...
        final String sensitiveStr = "UserEntryObject{user=User{username='脱*君', idCard='123456**********34', password='*******', email='123**@qq.com', phone='188****8888'}, userList=[User{username='脱*君', idCard='123456**********34', password='*******', email='123**@qq.com', phone='188****8888'}], userArray=[User{username='脱*君', idCard='123456**********34', password='*******', email='123**@qq.com', phone='188****8888'}]}";
    ...
    public void sensitiveUserGroupTest() {
        ...
        final String sensitiveStr = "UserGroup{coolUser=User{username='脱敏君', idCard='123456190001011234', password='1234567', email='12345@qq.com', phone='18888888888'}, user=User{username='脱*君', idCard='123456**********34', password='*******', email='123**@qq.com', phone='188****8888'}, userList=[User{username='脱*君', idCard='123456**********34', password='*******', email='123**@qq.com', phone='188****8888'}], userSet=[User{username='脱*君', idCard='123456**********34', password='*******', email='123**@qq.com', phone='188****8888'}], userCollection=[User{username='脱*君', idCard='123456**********34', password='*******', email='123**@qq.com', phone='188****8888'}], password='123456', userMap={map=User{username='脱*君', idCard='123456**********34', password='*******', email='123**@qq.com', phone='188****8888'}}}";
    ...
    public void sensitiveEntryObjectJsonTest() {
        final String originalStr = "UserEntryObject{user=User{username='脱敏君', idCard='123456190001011234', password='1234567', email='12345@qq.com', phone='18888888888'}, userList=[User{username='脱敏君', idCard='123456190001011234', password='1234567', email='12345@qq.com', phone='18888888888'}], userArray=[User{username='脱敏君', idCard='123456190001011234', password='1234567', email='12345@qq.com', phone='18888888888'}]}";
        final String sensitiveJson = "{\"user\":{\"email\":\"123**@qq.com\",\"idCard\":\"123456**********34\",\"password\":\"*******\",\"phone\":\"188****8888\",\"username\":\"脱*君\"},\"userArray\":[{\"email\":\"123**@qq.com\",\"idCard\":\"123456**********34\",\"password\":\"*******\",\"phone\":\"188****8888\",\"username\":\"脱*君\"}],\"userList\":[{\"email\":\"123**@qq.com\",\"idCard\":\"123456**********34\",\"password\":\"*******\",\"phone\":\"188****8888\",\"username\":\"脱*君\"}]}";
    ...
    public void sensitiveUserCollectionJsonTest() {
        ...
        final String sensitiveJson = "{\"userArray\":[{\"email\":\"123**@qq.com\",\"idCard\":\"123456**********34\",\"password\":\"*******\",\"phone\":\"188****8888\",\"username\":\"脱*君\"}],\"userCollection\":[{\"$ref\":\"$.userArray[0]\"}],\"userList\":[{\"$ref\":\"$.userArray[0]\"}],\"userMap\":{\"map\":{\"$ref\":\"$.userArray[0]\"}},\"userSet\":[{\"$ref\":\"$.userArray[0]\"}]}";
